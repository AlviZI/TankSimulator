...
public class TankBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.T)) //Rotasi berlawanan jarum jam
        {
            myTransform.Rotate(Vector3.back * kecepatanRotasi * Time.deltaTime, Space.Self);

        }
        else if (Input.GetKey(KeyCode.Y)) //Rotasi searah jarum jam
        {
        ...
        {
            if (Input.GetKey(KeyCode.U)) //Rotasi berlawanan jarum jam
            {
                selongsong.transform.Rotate(Vector3.left * kecepatanRotasi * Time.deltaTime, Space.Self);

            }
            else if (Input.GetKey(KeyCode.I)) //Rotasi searah jarum jam
            {
