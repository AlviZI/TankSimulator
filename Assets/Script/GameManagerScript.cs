...
public class GameManagerScript : MonoBehaviour
{
    ...
    void Update()
    {
        go_sudutMeriam.GetComponent<Text>().text =
            _torque.GetComponent<TankBehavior>().sudutMeriam.ToString();

        go_sudutTembak.GetComponent<Text>().text =
            _torque.GetComponent<TankBehavior>().nilaiRotasiY.ToString();

        go_kecepatanAwal.GetComponent<Text>().text =
            _torque.GetComponent<TankBehavior>().kecepatanAwalPeluru.ToString();
